# AI Native SW Expert Roadmap

SW College의 **AI Native 소프트웨어 전문가 직군 육성체계** 설계 시각화입니다.
...
- 설계 문서: `AI Native SW Expert Roadmap.md`
- 중급 과정 설계서: `중급 나노디그리/`

> 외부 공개본입니다. 사내 식별정보(실명·조직명·회사명 등)는 일반화 처리되었습니다.
